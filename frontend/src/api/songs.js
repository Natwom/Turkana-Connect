...
export const getTrendingSongs = (limit = 6) => api.get('/api/v1/songs', { params: { sort: 'trending', limit } })
export const getNewReleases = (limit = 6) => api.get('/api/v1/songs', { params: { sort: 'newest', limit } })
...
export default { getSongs, getTrendingSongs, getNewReleases, getSong, createSong, recordPlay, getStreamUrl }